 ...
 */
public class WechatMessageCodes {
    ...
    public static final String ENCRYPTED_DATA_EMPTY_EXCEPTION_MESSAGE = "密文为空";
    public static final String DATA_ENCRYPTED_EXCEPTION_MESSAGE = "数据解密失败";
