...
public enum BaseExceptionMessage implements IExceptionMessage {
     ...
     * 用户不存在
     */
    USER_NOT_EXIST_EXCEPTION(3013, USER_NOT_EXIST_EXCEPTION_CODE, USER_NOT_EXIST),
    /**
     * 用户保存失败
     */
    USER_SAVE_EXCEPTION(3014, USER_SAVE_EXCEPTION_CODE, USER_SAVE_EXCEPTION_MESSAGE),
    /**
     * 用户更新失败
     */
    USER_UPDATE_EXCEPTION(3015, USER_UPDATE_EXCEPTION_CODE, USER_UPDATE_EXCEPTION_MESSAGE),
    /**
     * 用户删除失败
     */
    USER_DELETE_EXCEPTION(3016, USER_DELETE_EXCEPTION_CODE, USER_DELETE_EXCEPTION_MESSAGE),
