...
import com.wpx.gatewaycms.GatewayCmsFeignService;
...
public class LoginService {
    ...
    @Autowired
    private GatewayCmsFeignService gatewayCmsFeignService;
    ...
    public String generateToken(String userId, String role) {
        ...
        ResultVO<LoginVO> login = gatewayCmsFeignService.login(loginDTO);
    ...
    public void removeToken(String userId) {
        ...
        gatewayCmsFeignService.logout(logoutDTO);
    }
